...
import 'admindash_board_screen.dart';
...
class AdminHomePage extends State<AdminHome> {
  ...
  Future<List> viewCategoryData() async {
    final responce = await http.get(Uri.parse(
        "https://nikiiashra.000webhostapp.com/Ewishes/category_view.php"));
...
class _Items extends State<Items> {
  ...
  void deleteCategory(var id) {
    var url =
        "https://nikiiashra.000webhostapp.com/Ewishes/category_delete.php";
  ...
  void updateCategoryName(var id) {
    var url =
        "https://nikiiashra.000webhostapp.com/Ewishes/category_update.php";
    http.post(Uri.parse(url), body: {
      'id': id,
