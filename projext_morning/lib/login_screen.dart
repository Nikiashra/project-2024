...
import 'package:projext_morning/singup_screen.dart';
import 'package:projext_morning/user/userdash_board_screen.dart';
import 'package:shared_preferences/shared_preferences.dart';

import 'admin/admindash_board_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _login() async {
    var response = await http.post(
        Uri.parse("https://nikiiashra.000webhostapp.com/Ewishes/login.php"),
        body: {
